export const countrySwagger = {
  ...
  "/api/countries/get-filterable-columns-data": {
    get: {
      tags: ["Country"],
      description:
        "Returns filterable column values for Country (e.g., name and code)",
      security: [{ bearerAuth: [] }],
      responses: {
        200: {
  ...
  "/api/country/update-status/{id_hash}/{isActive}": {
    patch: {
      tags: ["Country"],
      description:
        "Updates the `isActive` status of a specific country identified by its `id_hash`.",
      security: [{ bearerAuth: [] }],
      parameters: [
        {
          in: "path",
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  message: {
                    type: "string",
                    example: "Country status updated successfully.",
                  },
                },
              },
            },
